...
```{r}
# Finding the variance for the snails Length variable 
var(snails$Length)

# Finding the variance for the snails1 Length variable 
var(snails1$Length)

# Finding the variance for the snails2 Length variable 
var(snails2$Length)
```
...
ggplot(snails) + 
  ...
  ggtitle("Shell Type Lengths") +
  xlab("Index")
```


```{r}
png("outputs/plots/snails_ShellType.png")
ggplot(snails) + 
  geom_point(aes(x=1:nrow(snails), y=Length, colour = ShellType)) +
  ggtitle("Shell Type Lengths") +
  xlab("Index")
...
```{r}
ggplot(snails) + 
  geom_point(aes(x=1:nrow(snails), y=Width, colour = ShellType)) +
  ggtitle("Shell Type AperHt") +
  xlab("Index")
```

```{r}
ggplot(snails) + 
  geom_point(aes(x=1:nrow(snails), y=AperHt, colour = ShellType)) +
  ggtitle("Shell Type AperHt") +
  xlab("Index")
```
...
```{r}
ggplot(snails) + 
  geom_point(aes(x=1:nrow(snails), y=AperWdt, colour = ShellType)) +
  ggtitle("Shell Type AperWdt") +
  xlab("Index")
```

```{r}
ggplot(snails) + 
  geom_point(aes(x=1:nrow(snails), y=LU, colour = ShellType)) +
  ggtitle("Shell Type LU") +
  xlab("Index")
```

```{r}
ggplot(snails) + 
  geom_point(aes(x=1:nrow(snails), y=LipWdt, colour = ShellType)) +
  ggtitle("Shell Type LipWdt") +
  xlab("Index")
```

**OBSERVATIONS: ** It might be beneficial to conduct a clustering analysis of the data. The data could potentially indicate that the samples were collected at multiple sites and other variables may be more deterministic regarding endemic gastropods species flock formation. 
